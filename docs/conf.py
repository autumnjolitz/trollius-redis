...
try:
    ...
    release = pkg_resources.get_distribution('trollius_redis').version
except:
    release = '0.1.0'
...
latex_documents = [
  ('index', 'trollius_redis.tex', u'trollius\\_redis Documentation',
   u'Ben Jolitz', 'manual'),
]
...
texinfo_documents = [
  ('index', 'trollius_redis', u'trollius_redis Documentation',
   u'Ben Jolitz', 'trollius_redis', 'One line description of project.',
   'Miscellaneous'),
]
