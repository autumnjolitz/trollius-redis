...
class CommandCreator(object):
    ...
    def params(self):
        ...
        if types:
            return {k: v for k, v in zip(self.specs.args, types)}
        return {}
